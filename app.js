...
let btnC = document.querySelector(".btn-container")
...
function addButton() {
  btnC.innerHTML = createBTN("All") + "" + createBTN("Kore") + "" + createBTN("Cin") + "" + createBTN("Japon")

  document.getElementById('All').addEventListener('click', addAll)
  document.getElementById('Kore').addEventListener('click', addKore)
  document.getElementById('Japon').addEventListener('click', addJapon)
  document.getElementById('Cin').addEventListener('click', addChin)
